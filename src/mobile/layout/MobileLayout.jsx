...
import { Home, CheckSquare, MessageCircle, Bell, Briefcase, NotebookPen } from "lucide-react";
import logo from "../../assets/desktop/logo.svg";

// Mobile shell with top bar and bottom navigation for the client app.
const MobileLayout = () => {
  ...
  const navItems = [
    ...
    { to: "/notes", label: "Notes", icon: <NotebookPen size={20} /> },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto pb-16 px-3">
        <Outlet />
      </main>
